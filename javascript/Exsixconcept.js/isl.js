...
//isl_2020.map(object=>object.team).forEach(team=>console.log(team));
   //sort team in order of their matches played 

//isl_2020.sort((obj1,obj2)=>obj1.mp>obj2.mp?-1:1).forEach(obj=>console.log(obj));

let highpts=isl_2020.map(object=>object.pts).reduce((pts1,pts2)=>pts1>pts2?pts1:pts2)
console.log(highpts);
let lowpts=isl_2020.map(object=>object.pts).reduce((pts1,pts2)=>pts1>pts2?pts2:pts1)
console.log(lowpts);
